...
// import 'package:price_pred/screens/edit_screen.dart';
import 'package:price_pred/screens/show_image.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Future<GetPrediction> askPrediction(Uint8List img, int c) async {
      ...
      final response = await http.post(
        Uri.parse(
            'https://a5ef-2401-4900-62c7-3cad-d862-fdb2-ce8e-b5d4.in.ngrok.io/generate'),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          CircleAvatar(
                            backgroundColor: Color.fromARGB(255, 64, 14, 50),
                            radius: 40,
                            child: IconButton(
                                onPressed: () async {
